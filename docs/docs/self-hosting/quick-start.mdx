...
Whether you have a licence or want to trial Retrospected, you will be running in no time.

:::info No licence yet?
If you'd like to purchase one, [click here](https://www.retrospected.com/subscribe).
:::
...
:::tip Is it safe?
All passwords in this page are generated, **randomly**, on your **browser**. None of them are known to anyone except you.
