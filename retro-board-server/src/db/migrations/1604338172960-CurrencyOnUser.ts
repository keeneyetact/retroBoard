...
export class CurrencyOnUser1604338172960 implements MigrationInterface {
    name = 'CurrencyOnUser1604338172960'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD "currency" character varying`);
